...
int main (void) 
{
	...
	// Se emplea un puntero centinela para detectar que hemos recorrido 
	// completamente el vector.    

	int *p;		 // puntero para acceder a las componentes del vector 
	int *p_end;  // puntero centinela

	p_end = v+TOPE; // Centinela: apunta a la casilla siguiente a la ultima 
