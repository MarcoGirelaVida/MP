...
$(BIN)/potencial_docente : $(OBJ)/potencial_docente.o \
            ...
            $(LIB_CLASES_UTILS)/libProfesor.a           
	@echo 
	@echo Creando ejecutable: potencial_docente
	@echo 
...
$(OBJ)/potencial_docente.o : $(SRC)/potencial_docente.cpp \
	           $(wildcard $(INCLUDE)/*.h)
	@echo 
	@echo Creando objeto: potencial_docente.o
	@echo 
	g++ -c -o $(OBJ)/potencial_docente.o \
	          $(SRC)/potencial_docente.cpp \
        -I$(INCLUDE) -std=c++14
...
$(OBJ)/main_MP_Proyecto_Fase5.o : $(SRC)/main_MP_Proyecto_Fase5.cpp \
	           $(wildcard $(INCLUDE)/*.h)
	@echo 
	@echo Creando objeto: main_MP_Proyecto_Fase5.o
	@echo 
	g++ -c -o $(OBJ)/main_MP_Proyecto_Fase5.o \
	          $(SRC)/main_MP_Proyecto_Fase5.cpp \
        -I$(INCLUDE) -std=c++14
...
comprimir :
	tar -cvf MP_Proyecto_Fase7.tar src include obj lib bin datos MP_Proyecto_Fase7.mak