...
int main()
{
	...
	Profesor prof ("123456789", "Nombre", "Apellidos", "1/1/2022", 3);
	profesores += prof; 
	...
	cerr << "Hasta antes del constructor bien" << endl;
	...
	Adscripcion adscripcion ("123456789", "WXYZ");
