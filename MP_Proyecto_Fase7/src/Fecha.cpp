...
void Fecha :: setDia(int d)
{
    if (d < 1 || d > 31)
    {
        cerr << "Error: Dia incorrecto: dia >= 1 && dia <= 31" << endl;
        TodoNulo();
    }
...
void Fecha :: setMes(int m)
{
    if (m < 1 || m > 12)
    {
        cerr << "Error: Mes incorrecto (1-12)" << endl;
        TodoNulo();
    }
    mes = m;
}
...
void Fecha :: setAnyo(int a)
{
    ...
    if (a < 0000 || a > 9999)
    {
        cerr << "Error: Anyo incorrecto (a=>0000 && a<=9999)" << endl;
        TodoNulo();
    }
...
/***************************************************************************/
// TODONULO: Hace que la fecha sea nula
void Fecha :: TodoNulo(void)
{
    dia = 0;
    mes = 0;
    anyo = 0;
