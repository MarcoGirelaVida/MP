...
//----------------------------MÉTODOS------------------------------------//
/*************************************************************************/
// Métodos get, dado que no quiero modificarlos, los declaro como const             /*ADAPTAR*/
    ...
    string Departamento :: GetId_Dpto() const                                           /*ADAPTAR*/
    {
        string id = "VACIO";
        if (Id_depto != nullptr)
        {
...
// Métodos set
    ...
    void Departamento :: SetNombre(string nombre)                                               /*ADAPTAR*/
    {
            stoptr(nombre, Nombre);
    }


    void Departamento :: SetId_Dpto(string id)                                              /*ADAPTAR*/
    {
...
// Método ToString
    ...
    string Departamento :: ToString(string cadena_inicial, char delimitador) const              /*ADAPTAR*/
    {   
...
// TODONULO: Pone todos los atributos a nulo
    ...
    void Departamento :: TodoNulo (void)
    {
        string nulo = "NULO";
        stoptr(nulo, Nombre);
