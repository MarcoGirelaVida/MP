...
int main (int argc, char * argv[])
{
    ...
    // INPUT: Discusión de casos según el argumento 1 de argv.
	TipoRedimension el_tipo;

	if (argc == 1) // Valor por defecto
	{
	...
	VectorDinamico v1 = CreaVectorDinamico (TAM_INICIAL, el_tipo); 
	...
	while (strcmp(valor, "FIN")) {
		// no sé hacer esa función.
		TipoBase el_valor = TransformaATipoBase (valor); 
