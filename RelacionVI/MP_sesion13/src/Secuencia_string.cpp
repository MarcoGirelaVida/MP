...
TipoBaseSecuencia_string & Secuencia_string :: Valor (const int indice)
{
    return (el_valor(indice));
}

TipoBaseSecuencia_string & Secuencia_string :: Valor (const int indice) const
{
    return (el_valor(indice));
}
...
void Secuencia_string :: Aniade (TipoBaseSecuencia_string nuevo)
{
...
void Secuencia_string :: Inserta (int indice, TipoBaseSecuencia_string nuevo)
{
	// Comprobar si hay que redimensionar el array dinámico
	...
	memmove (&vector_privado[indice+1], &vector_privado[indice], 
                 total_utilizados-indice*sizeof(TipoBaseSecuencia_string)); 
...
void Secuencia_string :: Elimina (int indice)
{
    if ((indice >= 0) && (indice < total_utilizados)) {
		...
		memmove (&vector_privado[indice], &vector_privado[indice+1], 
                 (total_utilizados-indice-1)*sizeof(TipoBaseSecuencia_string));
...
{
	vector_privado = new TipoBaseSecuencia_string[num_casillas]; 
...
void Secuencia_string :: CopiarDatos (const Secuencia_string & otro)
{
	...
	memcpy (vector_privado, otro.vector_privado, 
            total_utilizados*sizeof(TipoBaseSecuencia_string));
}
...
void Secuencia_string :: Redimensionar (void)
{
	...
	TipoBaseSecuencia_string * tmp = new TipoBaseSecuencia_string[capacidad]; 

	// Copiar los datos 
	memcpy (tmp, vector_privado, total_utilizados*sizeof(TipoBaseSecuencia_string)); 
...
TipoBaseSecuencia_string & Secuencia_string :: el_valor (int indice) const
{
