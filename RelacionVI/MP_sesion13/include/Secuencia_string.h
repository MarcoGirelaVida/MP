...
#ifndef CLASS_SECUENCIA_TIPOBASE_STRING
#define CLASS_SECUENCIA_TIPOBASE_STRING
...
public:
    ...
    Secuencia_string (int la_capacidad=TAMANIO);
	
    /***********************************************************************/
    // Constructor de copia

    Secuencia_string (const Secuencia_string & otro);

    /***********************************************************************/
    // Destructor 

    ~Secuencia_string (void);
    ...
    void Clona (const Secuencia_string & otra);
...
private:
	...
	void CopiarDatos (const Secuencia_string & otro); 
